...
IMPORTS: List[Union[Import, ImportFrom]] = [
    ...
    ImportFrom(lineno=3, column=1, name="u", package="z", star=False, suggestions=[]),
    ImportFrom(lineno=3, column=2, name="u", package="z", star=False, suggestions=[]),
    ImportFrom(lineno=4, column=1, name="c", package="bb", star=False, suggestions=[]),
    ImportFrom(lineno=4, column=2, name="d", package="bb", star=False, suggestions=[]),
    ImportFrom(lineno=4, column=3, name="c", package="bb", star=False, suggestions=[]),
    ImportFrom(lineno=4, column=4, name="c", package="bb", star=False, suggestions=[]),
    ...
    ImportFrom(lineno=6, column=1, name="ll", package="ee", star=False, suggestions=[]),
    ImportFrom(lineno=6, column=2, name="el", package="ee", star=False, suggestions=[]),
    ImportFrom(lineno=6, column=3, name="ll", package="ee", star=False, suggestions=[]),
    ImportFrom(lineno=6, column=4, name="el", package="ee", star=False, suggestions=[]),
    ImportFrom(lineno=6, column=5, name="tl", package="ee", star=False, suggestions=[]),
    ImportFrom(lineno=6, column=6, name="tl", package="ee", star=False, suggestions=[]),
