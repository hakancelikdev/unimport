...
from unimport.constants import PY310_PLUS, PY311_PLUS, PY312_PLUS, PY313_PLUS, PY314_PLUS  # noqa using eval expression
...
def test_cases(path: Path, logger):
    ...
    if (
        ...
        and condition in ("not PY310_PLUS", "not PY311_PLUS", "not PY312_PLUS", "not PY313_PLUS", "not PY314_PLUS")
    ):
